  ...
  return (
    <section id="about" className="mt-12 md:mt-16 border-2 border-black bg-white p-4 md:p-8">
      <div className="grid md:grid-cols-3 gap-6 md:gap-8">
        <div>
          <h3 className="text-xl md:text-2xl font-bold mb-3 md:mb-4 border-b-2 border-black pb-2">MINISTRY</h3>
        ...
        <div>
          <h3 className="text-xl md:text-2xl font-bold mb-3 md:mb-4 border-b-2 border-black pb-2">EDUCATION</h3>
          <p className="text-sm leading-relaxed">
        ...
        <div>
          <h3 className="text-xl md:text-2xl font-bold mb-3 md:mb-4 border-b-2 border-black pb-2">LEADERSHIP</h3>
          <p className="text-sm leading-relaxed">
