export function PastorProfileSection() {
  return (
    <section id="profile" className="mt-12 md:mt-16 border-2 border-black bg-white p-4 md:p-8">
      <h2 className="text-3xl md:text-4xl font-bold mb-6 md:mb-8 text-center">PASTOR PROFILE</h2>

      <div className="grid lg:grid-cols-2 gap-8 md:gap-12">
        <div>
          <h3 className="text-xl md:text-2xl font-bold mb-4 md:mb-6 border-b-2 border-black pb-2">PASTORAL JOURNEY</h3>
        ...
        <div>
          <h3 className="text-xl md:text-2xl font-bold mb-4 md:mb-6 border-b-2 border-black pb-2">
            MINISTRY ACHIEVEMENTS
          </h3>
          <div className="space-y-4">
            <div>
              <h4 className="text-base md:text-lg font-bold mb-2">Academic Excellence</h4>
            ...
            <div>
              <h4 className="text-base md:text-lg font-bold mb-2">Church Leadership</h4>
              <p className="text-sm text-gray-700">
            ...
            <div>
              <h4 className="text-base md:text-lg font-bold mb-2">Family Life</h4>
              <p className="text-sm text-gray-700">
