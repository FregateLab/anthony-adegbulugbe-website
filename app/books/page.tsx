          ...
          <Card className="border-2 border-black bg-white">
            <CardContent className="p-4 sm:p-6 lg:p-8">
              <div className="grid lg:grid-cols-2 gap-6 sm:gap-8">
                ...
                {/* Book Details */}
                <div>
                  <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold mb-2 leading-tight">{book.title}</h3>
                  <p className="text-base sm:text-lg text-gray-600 mb-3 sm:mb-4">{book.subtitle}</p>
                  <p className="text-sm sm:text-base lg:text-lg font-medium mb-4">by {book.author}</p>
            ...
            <Card className="border-2 border-black bg-white">
              <CardContent className="p-4 sm:p-6">
                ...
                <div className="bg-gray-50 p-3 sm:p-4 border-l-4 border-red-600 mb-3 sm:mb-4">
                  <p className="text-xs sm:text-sm italic leading-relaxed">{book.excerpt}</p>
                </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
            ...
            <Card className="border-2 border-black bg-white hover:bg-gray-50 transition-colors">
              <CardContent className="p-3 sm:p-4">
                ...
                <h3 className="font-bold text-xs sm:text-sm mb-1 sm:mb-2 text-center leading-tight">JOURNEY OF LOVE</h3>
                <p className="text-xs text-gray-600 text-center mb-2 sm:mb-3">Messages on the Love of God</p>
                ...
                <div className="flex flex-col sm:flex-row gap-2">
                  <Link href="/books/1" className="flex-1">
                    <Button
                      variant="outline"
                ...
                <div className="text-center mb-3 sm:mb-4">
                  <div className="w-full h-40 sm:h-48 bg-black border-2 border-black overflow-hidden mb-2 sm:mb-3 relative">
                    ...
                    <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
                      <span className="bg-yellow-500 text-black px-2 sm:px-3 py-1 sm:py-2 text-xs sm:text-sm font-bold">COMING SOON</span>
                    </div>
                  </div>
                </div>

                <h3 className="font-bold text-xs sm:text-sm mb-1 sm:mb-2 text-center leading-tight">SHEPHERDING GOD'S FLOCK</h3>
                <p className="text-xs text-gray-600 text-center mb-2 sm:mb-3">Biblical Principles for Pastoral Ministry</p>
            ...
            {/* Coming Soon Book 2 */}
            <Card className="border-2 border-black bg-white hover:bg-gray-50 transition-colors sm:col-span-2 lg:col-span-1">
              <CardContent className="p-3 sm:p-4">
                <div className="text-center mb-3 sm:mb-4">
                  <div className="w-full h-40 sm:h-48 bg-black border-2 border-black overflow-hidden mb-2 sm:mb-3 relative">
                    <Image
                ...
                <h3 className="font-bold text-xs sm:text-sm mb-1 sm:mb-2 text-center leading-tight">THE PASTOR'S HEART</h3>
                <p className="text-xs text-gray-600 text-center mb-2 sm:mb-3">Leadership in Christ Apostolic Church</p>
