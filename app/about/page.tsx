    ...
    <div className="min-h-screen bg-[#f5f1e8]">
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <section className="mb-16 border-2 border-black bg-white p-8">
          <h2 className="text-3xl font-bold mb-8 border-b-2 border-black pb-4">MINISTRY FOUNDATION</h2>

          <div className="grid md:grid-cols-3 gap-8">
            <div>
              <h3 className="text-2xl font-bold mb-4 border-b-2 border-black pb-2">SCRIPTURE-CENTERED</h3>
            ...
            <div>
              <h3 className="text-2xl font-bold mb-4 border-b-2 border-black pb-2">PASTORAL CARE</h3>
              <p className="text-sm leading-relaxed">
            ...
            <div>
              <h3 className="text-2xl font-bold mb-4 border-b-2 border-black pb-2">SERVANT LEADERSHIP</h3>
              <p className="text-sm leading-relaxed">
        ...
        {/* Our Mission */}
        <section className="mb-16 border-2 border-black bg-white p-8">
          <h2 className="text-3xl font-bold mb-8 border-b-2 border-black pb-4">OUR MISSION</h2>
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8 mt-12">
              <div className="border-l-4 border-red-600 pl-6 text-left">
                <h3 className="text-lg font-bold mb-3">SPIRITUAL FORMATION</h3>
        ...
        {/* Ministry Values */}
        <section className="mb-16 border-2 border-black bg-white p-8">
          <h2 className="text-3xl font-bold mb-8 border-b-2 border-black pb-4">MINISTRY VALUES</h2>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-bold mb-2">BIBLICAL AUTHORITY</h4>
                    <p className="text-sm text-gray-700">
                ...
                <div className="flex items-start gap-4">
                  <div className="w-4 h-4 bg-red-600 rounded-full mt-1 flex-shrink-0"></div>
                  <div>
                    <h4 className="font-bold mb-2">PASTORAL HEART</h4>
                    <p className="text-sm text-gray-700">
            ...
            <div>
              <h3 className="text-2xl font-bold mb-6">MINISTRY APPROACH</h3>
              <div className="space-y-6">
                <div className="border-2 border-black p-4">
                  <h4 className="font-bold mb-2">EXPOSITORY PREACHING</h4>
                  <p className="text-sm">
                ...
                <div className="border-2 border-black p-4">
                  <h4 className="font-bold mb-2">DISCIPLESHIP FOCUS</h4>
                  <p className="text-sm">
        ...
        <section className="mb-16 border-2 border-black bg-white p-8">
          <h2 className="text-3xl font-bold mb-8 border-b-2 border-black pb-4">CHRIST APOSTOLIC CHURCH HERITAGE</h2>

          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-xl font-bold mb-4 text-red-600">OUR CHURCH TRADITION</h3>
            ...
            <div>
              <h3 className="text-xl font-bold mb-4 text-red-600">DENOMINATIONAL VALUES</h3>
        ...
        {/* Ministry Programs */}
        <section className="mb-16 border-2 border-black bg-white p-8">
          <h2 className="text-3xl font-bold mb-8 border-b-2 border-black pb-4">SIGNATURE MINISTRY PROGRAMS</h2>

          <div className="grid lg:grid-cols-2 gap-8">
            <div className="border-2 border-black p-6">
              <h3 className="text-2xl font-bold mb-4 text-red-600">OPERATION DECLARE AND DECREE</h3>
              <p className="text-sm leading-relaxed mb-4">
            ...
            <div className="border-2 border-black p-6">
              <h3 className="text-2xl font-bold mb-4 text-red-600">HOURS OF DIVINE INTERVENTION</h3>
              <p className="text-sm leading-relaxed mb-4">
        ...
        <section className="border-2 border-black bg-white p-8">
          <h2 className="text-3xl font-bold mb-8 border-b-2 border-black pb-4">CONNECT WITH OUR MINISTRY</h2>

          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div>
              <h3 className="text-xl font-bold mb-4 text-red-600">PASTORAL CARE</h3>
            ...
            <div>
              <h3 className="text-xl font-bold mb-4 text-red-600">MINISTRY OPPORTUNITIES</h3>
              <p className="text-sm mb-4">
            ...
            <div>
              <h3 className="text-xl font-bold mb-4 text-red-600">LOCATION</h3>
              <p className="text-sm mb-4">
