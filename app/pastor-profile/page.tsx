    ...
    <div className="min-h-screen bg-[#f5f1e8]">
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-16">
          ...
          <div className="border-2 border-black p-8 bg-white">
            ...
            <div className="space-y-4 text-lg">
              <p className="font-bold text-red-600">Zonal Superintendent</p>
              <p className="font-medium">Christ Apostolic Church, Nigeria and Overseas</p>
              <p className="text-sm">Born April 2nd, 1955, Ondo State, Nigeria</p>

              <div className="bg-red-600 text-white p-4 mt-6">
        ...
        <section className="mb-16 border-2 border-black bg-white p-8">
          <h2 className="text-3xl font-bold mb-8 border-b-2 border-black pb-4">EARLY LIFE & CHRISTIAN JOURNEY</h2>

          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-xl font-bold mb-4">HUMBLE BEGINNINGS</h3>
            ...
            <div>
              <h3 className="text-xl font-bold mb-4">CALL TO MINISTRY</h3>
              <p className="text-sm leading-relaxed mb-4">
        ...
        {/* Academic Excellence */}
        <section className="mb-16 border-2 border-black bg-white p-8">
          <h2 className="text-3xl font-bold mb-8 border-b-2 border-black pb-4">ACADEMIC EXCELLENCE</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-lg font-bold mb-2">FIRST-CLASS HONORS</h3>
              <p className="text-sm">B.Sc. in Electrical Engineering from University of Ife (now OAU)</p>
            </div>

            <div className="text-center">
              <div className="w-20 h-20 bg-black text-white rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-lg font-bold">D.Sc</span>
              </div>
              <h3 className="text-lg font-bold mb-2">DOCTORATE DEGREE</h3>
              <p className="text-sm">D.Sc. from MIT in Nuclear Materials Engineering</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-bold mb-2">YEARS OF SERVICE</h3>
              <p className="text-sm">Over 40 years in academia, government, and church ministry</p>
            </div>
          </div>
        </section>
        ...
        {/* Professional Career */}
        <section className="mb-16 border-2 border-black bg-white p-8">
          <h2 className="text-3xl font-bold mb-8 border-b-2 border-black pb-4">PROFESSIONAL CAREER</h2>

          <div className="space-y-8">
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-xl font-bold mb-4 text-red-600">ACADEMIC LEADERSHIP</h3>
                <div className="space-y-4">
                  <div>
                    <h4 className="font-bold">Director, Center for Energy Research</h4>
                    <p className="text-sm text-gray-700">Obafemi Awolowo University (OAU)</p>
                  </div>
                  <div>
                    <h4 className="font-bold">Chancellor</h4>
                    <p className="text-sm text-gray-700">Joseph Ayo Babalola University (Current)</p>
                  </div>
                </div>
              </div>

              <div>
                <h3 className="text-xl font-bold mb-4 text-red-600">GOVERNMENT SERVICE</h3>
                <div className="space-y-4">
                  <div>
                    <h4 className="font-bold">Presidential Adviser on Energy</h4>
                    <p className="text-sm text-gray-700">To President Obasanjo</p>
                  </div>
                  <div>
                    <h4 className="font-bold">Educational Governance</h4>
                    <p className="text-sm text-gray-700">Significant contributions to educational governance</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        {/* Ministry Leadership */}
        <section className="mb-16 border-2 border-black bg-white p-8">
          <h2 className="text-3xl font-bold mb-8 border-b-2 border-black pb-4">MINISTRY LEADERSHIP</h2>

          <div className="grid lg:grid-cols-2 gap-12">
            <div>
              <h3 className="text-2xl font-bold mb-6">PASTORAL PROGRESSION</h3>
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="w-4 h-4 bg-red-600 rounded-full mt-1 flex-shrink-0"></div>
                  <div>
                    <h4 className="font-bold">Choir Member</h4>
                    <p className="text-sm text-gray-700">CAC Oke-Ibukun, Ibadan</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-4 h-4 bg-red-600 rounded-full mt-1 flex-shrink-0"></div>
                  <div>
                    <h4 className="font-bold">Elder</h4>
                    <p className="text-sm text-gray-700">Christ Apostolic Church</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-4 h-4 bg-red-600 rounded-full mt-1 flex-shrink-0"></div>
                  <div>
                    <h4 className="font-bold">Pastor</h4>
                    <p className="text-sm text-gray-700">CAC Adesanmi, Ile-Ife</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-4 h-4 bg-red-600 rounded-full mt-1 flex-shrink-0"></div>
                  <div>
                    <h4 className="font-bold">District Superintendent (2018)</h4>
                    <p className="text-sm text-gray-700">CAC All Saints' Chapel, Citec, Abuja</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-4 h-4 bg-red-600 rounded-full mt-1 flex-shrink-0"></div>
                  <div>
                    <h4 className="font-bold">Zonal Superintendent (Current)</h4>
                    <p className="text-sm text-gray-700">Christ Apostolic Church, Nigeria and Overseas</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              <h3 className="text-2xl font-bold mb-6">SIGNATURE PROGRAMS</h3>
              <div className="space-y-6">
                <div className="border-l-4 border-red-600 pl-4">
                  <h4 className="text-lg font-bold mb-2">Operation Declare and Decree</h4>
                ...
                <div className="border-l-4 border-red-600 pl-4">
                  <h4 className="text-lg font-bold mb-2">Hours of Divine Intervention</h4>
                  <p className="text-sm text-gray-700">
        ...
        {/* Welfare & Empowerment */}
        <section className="mb-16 border-2 border-black bg-white p-8">
          <h2 className="text-3xl font-bold mb-8 border-b-2 border-black pb-4">WELFARE & EMPOWERMENT INITIATIVES</h2>

          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-xl font-bold mb-4 text-red-600">PASTORAL WELFARE SCHEME</h3>
              <p className="text-sm leading-relaxed mb-4">
            ...
            <div>
              <h3 className="text-xl font-bold mb-4 text-red-600">WOMEN EMPOWERMENT PROGRAMS</h3>
              <p className="text-sm leading-relaxed mb-4">
        ...
        {/* Family Life */}
        <section className="mb-16 border-2 border-black bg-white p-8">
          <h2 className="text-3xl font-bold mb-8 border-b-2 border-black pb-4">FAMILY LIFE</h2>
        ...
        <section className="border-2 border-black bg-white p-8">
          <h2 className="text-3xl font-bold mb-8 border-b-2 border-black pb-4">LEGACY & IMPACT</h2>

          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div>
              <h3 className="text-xl font-bold mb-4 text-red-600">ACADEMIC LEGACY</h3>
              <p className="text-sm">
            ...
            <div>
              <h3 className="text-xl font-bold mb-4 text-red-600">MINISTRY IMPACT</h3>
              <p className="text-sm">
            ...
            <div>
              <h3 className="text-xl font-bold mb-4 text-red-600">SERVANT LEADERSHIP</h3>
              <p className="text-sm">
