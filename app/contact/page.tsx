  ...
  return (
    <div className="min-h-screen bg-[#f5f1e8]">
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        {/* Success Message */}
        {isSubmitted && (
          <div className="border-2 border-green-600 bg-green-50 p-6 mb-8 text-center">
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-16">
          ...
          <div className="border-2 border-black bg-white p-8">
            <h2 className="text-3xl font-bold mb-6 border-b-2 border-black pb-4">GET IN TOUCH</h2>
          ...
          <div className="space-y-8">
            {/* Direct Contact */}
            <div className="border-2 border-black bg-white p-8">
              <h3 className="text-2xl font-bold mb-6 border-b-2 border-black pb-4">DIRECT CONTACT</h3>
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <Mail className="w-6 h-6 text-red-600 mt-1 flex-shrink-0" />
                  <div>
                    <h4 className="font-bold mb-1">EMAIL</h4>
                    <p className="text-sm text-gray-700">anthony.adegbulugbe@gmail.com</p>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-700">+234-807-777-7856</p>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-700">Lagos, Nigeria</p>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-700">9:00 AM - 5:00 PM WAT</p>
            ...
            {/* Ministry Areas */}
            <div className="border-2 border-black bg-white p-8">
              <h3 className="text-2xl font-bold mb-6 border-b-2 border-black pb-4">MINISTRY AREAS</h3>
              <div className="grid grid-cols-2 gap-4">
                <div className="text-center p-4 border border-gray-200">
                  <Heart className="w-8 h-8 text-red-600 mx-auto mb-2" />
                  <h4 className="font-bold text-sm">PASTORAL CARE</h4>
                  <p className="text-xs text-gray-600">Counseling & Support</p>
                </div>
                <div className="text-center p-4 border border-gray-200">
                  <Pray className="w-8 h-8 text-red-600 mx-auto mb-2" />
                  <h4 className="font-bold text-sm">PRAYER MINISTRY</h4>
                  <p className="text-xs text-gray-600">Intercession & Healing</p>
                </div>
                <div className="text-center p-4 border border-gray-200">
                  <BookOpen className="w-8 h-8 text-red-600 mx-auto mb-2" />
                  <h4 className="font-bold text-sm">DISCIPLESHIP</h4>
                  <p className="text-xs text-gray-600">Spiritual Growth</p>
                </div>
                <div className="text-center p-4 border border-gray-200">
                  <Users className="w-8 h-8 text-red-600 mx-auto mb-2" />
                  <h4 className="font-bold text-sm">LEADERSHIP</h4>
        ...
        {/* Ministry Programs */}
        <section className="border-2 border-black bg-white p-8 mb-12">
          <h2 className="text-3xl font-bold mb-8 border-b-2 border-black pb-4">CONNECT WITH OUR PROGRAMS</h2>
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="border-2 border-black">
              <CardContent className="p-6">
                <h3 className="text-xl font-bold mb-4 text-red-600">OPERATION DECLARE AND DECREE</h3>
            ...
            <Card className="border-2 border-black">
              <CardContent className="p-6">
                <h3 className="text-xl font-bold mb-4 text-red-600">HOURS OF DIVINE INTERVENTION</h3>
                <p className="text-sm text-gray-700 mb-4">
        ...
        {/* Emergency Contact */}
        <section className="border-2 border-red-600 bg-red-50 p-8 text-center">
          <h2 className="text-2xl font-bold mb-4 text-red-800">EMERGENCY PASTORAL CARE</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <div className="flex items-center gap-2 text-red-800">
              ...
              <span className="font-bold">Emergency Line: +234-807-777-7856</span>
            </div>
            <div className="flex items-center gap-2 text-red-800">
              <Mail className="w-5 h-5" />
              <span className="font-bold">urgent@cac.ng</span>
            </div>
          </div>
        </section>
      </main>
